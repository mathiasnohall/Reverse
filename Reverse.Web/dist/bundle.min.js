...
"use strict";var reverseApp=angular.module("reverseApp",["services"]),services=angular.module("services",["ngResource"]);reverseApp.run(["$rootScope","$document",function(e,r){e.language=r[0].documentElement.lang}]),reverseApp.config(["$locationProvider",function(e){e.html5Mode({enabled:!0,requireBase:!1})}]);
"use strict";reverseApp.constant("CONFIG",{apiUrl:"http://localhost:52434/"});
"use strict";services.factory("reverseService",["$log","$http","CONFIG",function(e,r,t){return{postForm:function(e){return r.post(t.apiUrl+"reverse/reverse",e).then(function(e){return e.data})}}}]);
"use strict";services.factory("statusService",["$log","$http","CONFIG",function(t,e,r){return{getStatus:function(t){return e.get(r.apiUrl+"status/status").then(function(t){return t.data})}}}]);
"use strict";reverseApp.controller("reverseController",["$scope","reverseService",function(e,r){e.submitForm=function(){r.postForm(e.form).then(function(r){e.response=r,e.success=!0})}}]);
"use strict";reverseApp.controller("statusController",["$scope","statusService",function(t,e){t.getStatus=function(){e.getStatus().then(function(){t.greeting="Hola reverse!"})},t.getStatus()}]);
