...
"use strict";reverseApp.constant("CONFIG",{apiUrl:"localhost:52434"});
"use strict";services.factory("statusService",["$log","$http","CONFIG",function(t,s,r){return{status:function(t){return s.get(r.apiUrl+"status/status").then(function(t){return t.data})}}}]);
