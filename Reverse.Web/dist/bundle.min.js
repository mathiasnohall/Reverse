...
"use strict";services.factory("reverseService",["$log","$http","CONFIG",function(e,r,t){return{postForm:function(e){return r.post(t.apiUrl+"reverse/reverse",data).then(function(e){return e.data})}}}]);
...
"use strict";reverseApp.controller("reverseController",["$scope","reverseService",function(e,r){e.submitForm=function(o){r.postForm(o).then(function(r){e.response=r})}}]);
